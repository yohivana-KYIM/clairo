...
#[ORM\Entity(repositoryClass: DemandeTitreCirculationRepository::class)]
class DemandeTitreCirculation
{
    ...
    #[ORM\OneToOne(cascade: ['persist', 'remove'])]
    private ?InfoComplementaire $infocomplementaire = null;
    ...
    #[ORM\ManyToOne(inversedBy: 'demandeTitreCirculations')]
    ...
    public function getInfocomplementaire(): ?InfoComplementaire
    {
        return $this->infocomplementaire;
    }

    public function setInfocomplementaire(?InfoComplementaire $infocomplementaire): static
    {
