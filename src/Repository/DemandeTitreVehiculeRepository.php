...
class DemandeTitreVehiculeRepository extends ServiceEntityRepository
{
    public function __construct(ManagerRegistry $registry)
    {
        parent::__construct($registry, DemandeTitreVehicule::class);
    }

    public function findOneByUser($user): ?DemandeTitreVehicule
    {
